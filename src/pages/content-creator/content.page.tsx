    ...
    <>
      <section className="flex flex-row w-auto justify-between pt-12 mx-auto">
        <div className="w-1/2 flex flex-col px-6 space-y-6 text-white text-right">
          ...
          <div>
            <div className="flex items-center justify-center md:space-x-5 mt-6 flex-wrap gap-2">
            ...
            <div className="md:block hidden"><SlideComponent /></div>
          </div>
        </div>
        <div className="justify-center items-start flex md:w-auto md:justify-center md:items-end">
          <img
            src="/images/Dic1.jpg"
            alt=""
